                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Должники</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="card shadow-sm rounded">
            <div class="card-body">
                <div class="list-group list-group-horizontal mb-4" id="inbox-menu">
                    ...
                    <a href="{{ route('child_debit') }}" class="list-group-item list-group-item-action active">Должники</a>
                </div>
