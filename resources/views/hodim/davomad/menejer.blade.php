                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="list-group">
                            <a href="{{ route('hodim_davomad_meneger') }}" class="list-group-item list-group-item-action text-center active">Менеджеры</a>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="list-group">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="statuses[{{ $item['id'] }}]" class="form-select" required>
                                                                ...
                                                                <option value="absent" {{ $item['status'] === 'absent' ? 'selected' : '' }}>Отсутствует</option>
