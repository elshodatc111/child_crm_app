        ...
        <div class="card shadow-sm rounded">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="list-group">
                            <a href="{{ route('hodim_davomad_hodim') }}" class="list-group-item list-group-item-action text-center ">Сотрудники</a>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="list-group">
                            <a href="{{ route('hodim_davomad_techer') }}" class="list-group-item list-group-item-action text-center active">Поварa</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <h5 class="card-title d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#davomadModal">
                        <i class="bi bi-plus-circle me-1"></i> Взять посещаемость
                    </button>
                </h5>
                ...
                <div class="text-center mt-3">
                    ...
                    <span class="badge bg-info text-dark badge-status">
                        <i class="bi bi-person-x"></i> Без формы
                    </span>
                    <span class="badge bg-secondary badge-status">
                        <i class="bi bi-calendar-x"></i> Не рабочий день
                    </span>
                        ...
                        <form action="{{ route('meneger_davomad_store') }}" method="POST">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="davomadModalLabel">Взять посещаемость</h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="statuses[{{ $item['id'] }}]" class="form-select" required>
                                                                ...
                                                                <option value="no_uniform" {{ $item['status'] === 'no_uniform' ? 'selected' : '' }}>Без формы</option>
                                                                <option value="off_day" {{ $item['status'] === 'off_day' ? 'selected' : '' }}>Не рабочий день</option>
                                                            </select>
                                                        </td>
                                                    </tr>
                                                @endforeach
