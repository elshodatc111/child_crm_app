        ...
        <div class="card shadow-sm rounded">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="list-group">
                            <a href="{{ route('hodim_davomad_tarbiyachi') }}" class="list-group-item list-group-item-action text-center active">Воспитатели</a>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="list-group">
                    ...
                    <div class="col-lg-3">
                        <div class="list-group">
                            <a href="{{ route('hodim_davomad_techer') }}" class="list-group-item list-group-item-action text-center ">Повар</a>
                        </div>
                    </div>
                </div>
            </div>
