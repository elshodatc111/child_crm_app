                    ...
                    <div class="row mb-4">
                        <div class="col-lg-6">
                            <div class="list-group">
                                <a href="{{ route('meneger_show', $id) }}" class="list-group-item list-group-item-action text-center ">О менеджере</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="list-group">
                                <a href="{{ route('meneger_show_paymart', $id) }}" class="list-group-item list-group-item-action text-center active">Выплаты зарплаты</a>
                            </div>
                        </div>
                    </div>
                </div>
