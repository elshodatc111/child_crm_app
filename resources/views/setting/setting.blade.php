            ...
            <div class="col-lg-12">
                <div class="card shadow-lg border-0 rounded-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Дополнительные выходные дни</h5>
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addHolidayModal">
                            <i class="bi bi-plus-circle me-1"></i> Добавить новый
                        </button>
                    </div>
                    <div class="card-body">
...
<!-- Модальное окно: Добавить новый выходной день -->
<div class="modal fade" id="addHolidayModal" tabindex="-1" aria-labelledby="addHolidayModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow rounded-4">
            <div class="modal-header">
                <h5 class="modal-title" id="addHolidayModalLabel">Добавить новый выходной день</h5>
            ...
            <form action="{{ route('setting_create_day') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="comment" class="form-label">Название выходного дня</label>
